...
const bulkActionBar = cva(
  "flex items-center justify-between gap-group-md rounded-md border border-[var(--color-border-default)] bg-[var(--color-bg-secondary)] px-4 py-2",
);
...
export function BulkActionListPageTemplate<TData>({
  ...
  return (
    <div className={cn("flex w-full flex-col gap-group-lg", className)}>
      <PageHeader
        title={title}
